...
$(document).ready(function () {
	...
	$.each(RegionesYcomunas.regiones, function () {
        htmlRegion = htmlRegion + '<option value="' + 
		...
		$.each(RegionesYcomunas.regiones, function () {
			if (RegionesYcomunas.regiones[iRegiones].NombreRegion == valorRegion) {
				...
				$.each(RegionesYcomunas.regiones[iRegiones].comunas, function () {
                    htmlComuna =    htmlComuna + '<option value="' + 
    ...
    {
        var iRegiones = 0;
        var valorRegion = 'Arica y Parinacota';
	...
	{
		if(!window.reg == '' || !windows.com == ''){
			document.getElementById("regiones").value = window.reg;

			var iRegiones = 0;
			var valorRegion = window.reg;
			...
			document.getElementById("comunas").value = window.com;
		}
	}
